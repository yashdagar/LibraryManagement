...
//    public void createDueDateReminder(Student student, LibraryRequest libraryRequest, int daysRemaining) {
//        String title = "Due Date Reminder";
//        String message = "Book '" + libraryRequest.getBook().getTitle() + "' is due in " + daysRemaining + " days.";
//
...
//    }
//
//    public void createFineAlert(Student student, LibraryRequest librayRequest, double fineAmount) {
//        String title = "Fine Alert";
//        String message = "You have incurred a fine of $" + fineAmount +
//                " for late return of book '" + librayRequest.getBook().getTitle() + "'.";
//
//        Notification notification = new Notification(
//                nextId++,
//                title,
