...
public class AdminLoginPage extends JPanel {
    private final Color primaryColor = new Color(220, 38, 38); // Red color for admin
    ...
    public AdminLoginPage(AdminAppFrame appFrame) {
        appFrame.setTitle("LibraryX - Admin Portal");
    ...
    private JPanel createLogoPanel() {
        ...
        try {
            bufferedImage = ImageIO.read(new File("assets/admin_logo.png"));
        } catch (Exception e) {
        ...
        // Tagline
        JLabel taglineLabel = new JLabel("System Administration Portal");
    ...
    private JPanel createLoginFormPanel(AdminAppFrame appFrame) {
        ...
        JLabel subtitleLabel = new JLabel("Sign in to access the admin dashboard");
        ...
        RoundedPanelButton signInButton = new RoundedPanelButton("Sign In", "", e -> {
            ...
            // Authenticate admin
            final Optional<Admin> result = authService.loginAdmin(email, password);
            if(result.isPresent()){
                ...
                appFrame.showAdminDashboard(result.get());
            } else {
                JOptionPane.showMessageDialog(this,
        ...
        JLabel registerText = new JLabel("New administrator? ");
    ...
    private JPanel createRegisterFormPanel(AdminAppFrame appFrame) {
        // Main container with padding
        JPanel mainContainer = new JPanel(new GridBagLayout());
        mainContainer.setBackground(backgroundColor);
        ...
        JLabel subtitleLabel = new JLabel("Create a new administrator account");
        subtitleLabel.setFont(new Font("Arial", Font.PLAIN, 14));
        subtitleLabel.setForeground(new Color(107, 114, 128));
        subtitleLabel.setAlignmentX(Component.LEFT_ALIGNMENT);
        ...
        // Phone field - replaced Role field
        ...
        RoundedPanelButton registerButton = new RoundedPanelButton("Register", "", e -> {
            ...
            // Register admin
            boolean isRegistered = authService.registerAdmin(name, email, password, phone);
